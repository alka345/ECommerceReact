...
<div className='space-y-12'>
        ...
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base  text-2  font-semibold leading-7 text-gray-900">Personal Information</h2>
    ...
    <div className="mx-auto mt-24  max-w-2xl px-4 sm:px-6 lg:px-2">
        <h2 className='text-4xl font-bold tracking-tight text-gray-800 px-4 py-6 sm:px-6'>Cart</h2>
        <div className="mt-8">
